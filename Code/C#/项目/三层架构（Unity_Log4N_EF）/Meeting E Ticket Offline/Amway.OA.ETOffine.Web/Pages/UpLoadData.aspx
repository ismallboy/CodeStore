<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Site.Master" AutoEventWireup="true" CodeBehind="UpLoadData.aspx.cs" Inherits="Amway.OA.ETOffine.Web.Pages.UpLoadData" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../Scripts/ETOffine/UpLoadData.js"></script>
</asp:Content>
         ...
         <div class="PageContent box">
            ...
            <div class="PageMain">
                ...
                <table width="100%" cellspacing="0" cellpadding="0" style="padding: 20px 0;">
                    <tr>
                        ...
                        <td width="180" align="center" class="bg-shadow verticalTop">
                            <asp:LinkButton ID="lbtUpLoad" runat="server" CssClass="page-btnBig lhbig" OnClick="ltnUpload_Click">上传验票数据</asp:LinkButton>
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <div class="Activities-btn">
                    <a onclick="UpLoadData.btnView()" class="page-btn-blue">查看活动信息</a>
