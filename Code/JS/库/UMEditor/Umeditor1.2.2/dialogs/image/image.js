(function () {
    ...
    var Upload = {
        ...
        uploadComplete: function (data) {
            var me = this;
            try {
                //update  by  bin_su 2015-9-15  使用自定义上传图片功能

                if (typeof (data) != 'undefined' && data != undefined && data != null) {
                    var json = JSON.parse(data);
                    if (json.Error == '') {
                        Base.callback(me.editor, me.dialog, json.FileDetail.URL.replace(me.editor.getOpt('upLoadFileLocationUrl'), me.editor.getOpt('downLoadFileLocationUrl')), "SUCCESS");
                        return;
                    }
                }
            } catch (e) {
        ...
        submit: function (callback) {
            ...
            $(me.dialog).delegate(".edui-image-file", "change", function (e) {
                ...
                //解决跨域问题 by bin_su 2015年9月23日 11:46:20                            
                me.setDomain(me.editor.getOpt('fileServerDomain'));
